...
// I will write a simple TS parser using standard regex for the most common exported functions.
// But as a faster and less error-prone path, what if I just use the "Facade" pattern?
// Create clustering.ts, write all clustering logic, and then delete it from processing.ts.
// I will output the precise line ranges to help myself construct it.
...
[
  ...
  "calculateWeightedEntitySimilarity", "calculateShingleSimilarity", 
