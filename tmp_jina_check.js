...
async function run() {
  ...
  try {
    const [e1, e2, e3] = await Promise.all([
      getEmbedding('Modi visits Japan for bilateral talks'),
      getEmbedding('PM lands in Tokyo for diplomatic meeting'),
      getEmbedding('India cricket team wins test match')
    ]);
